...
function GetCompleteName() {
	 ...
	 var completeName=firstName +" " +lastName; alert('Hello '+ completeName + " welcome to our page");
}
...
function Addnum(){
	 ...
	 var sum=num1+num2; alert("Submission of two numbers is "+sum);
}
...
function Calculator(){ 
  ...
  if (opt==="+") { alert("Addition result is "+ (num1+num2)); 
  } 
